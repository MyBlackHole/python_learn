...
class AcsClient(object):
    ...
    def _resolve_endpoint(self, request):
        ...
        if request.get_location_service_code() is not None:
            endpoint = self._location_service.find_product_domain(self.get_region_id(),
    ...
    def _implementation_of_do_action(self, request):
        ...
        try:
            ...
            raise ClientException(error_code.SDK_SERVER_UNREACHABLE,
    ...
    def do_action(self, acs_request):
        warnings.warn("do_action() method is deprecated, please use do_action_with_exception() instead.",
                      DeprecationWarning)
        status, headers, body = self._implementation_of_do_action(acs_request)
        return body

    def get_response(self, acs_request):
        warnings.warn("get_response() method is deprecated, please use do_action_with_exception() instead.",
                      DeprecationWarning)
