...
from qapi.utils import generate_full_uri
...
from .models import WxUserInfo, UserRelation, WxUserAccountLog, Withdraw, WithdrawOperationLog, RechargeRecord, \
    WxUserCreditLog
...
class WxUserAccountLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'user_info', 'asset', 'a_type', 'referral_name', 'remark', 'number', 'cost', 'add_time', 'note', 'detail',
            'referral_avatar_url')
