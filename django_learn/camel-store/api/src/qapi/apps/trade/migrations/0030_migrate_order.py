    ...
    with transaction.atomic():
        for order in Order.objects.all():
            ...
            for i in order.items.all():
                goodsbackup = GoodsBackup.objects.create(order=instance, goods=i.goods,
                                                         gtype_id=getattr(i.gtype, 'id', None), goods_name=i.goods_name,
                                                         gtype_name=i.gtype_name, g_image=i.g_image, price=i.price,
                                                         original_price=i.original_price, market_price=i.market_price,
                                                         num=i.num,
                                                         share_user_id=i.share_user_id, g_rebate=i.g_rebate,
                                                         g_bonus=i.g_bonus,
