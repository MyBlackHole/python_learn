    ...
    operations = [
        migrations.AddField(
            ...
            field=django.contrib.postgres.fields.ArrayField(
                base_field=models.CharField(choices=[('own', '商家自配送'), ('express', '快递配送'), ('buyer', '用户自提')],
                                            max_length=128), default=list, size=None),
        ),
        migrations.AlterField(
            model_name='goods',
            name='delivery_method',
            field=models.CharField(blank=True, choices=[('own', '商家自配送'), ('express', '快递配送'), ('buyer', '用户自提')],
                                   max_length=128, null=True, verbose_name='配送方式'),
        ),
    ]
