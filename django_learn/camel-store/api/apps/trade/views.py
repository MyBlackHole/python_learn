...
class CartBuyView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # print(type(request._request.POST))
        # print(request._request.POST.gitlist())
        # print(request.data)
        print('ok')
...
class ConfirmReceipt(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        orders = Orders.objects.filter(model_type__in=[Orders.ORD, Orders.REPL], status=Orders.RECEIVING,
                                       flag_time__lte=timezone.now())
