    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.IntegerField(choices=[(0, '在售'), (1, '预览'), (2, '下架')], default=0, verbose_name='商品状态')),
                ('index', models.IntegerField(default=0, verbose_name='优先级')),
                ('duration', models.CharField(choices=[('long_term', '长期'), ('time_frame', '时间范围')], max_length=128,
                                              verbose_name='持续时间设置')),
                ...
                ('delivery_method',
                 models.CharField(choices=[('own', '自配送'), ('express', '快递')], max_length=128, verbose_name='配送方式')),
                ('pick_up', models.BooleanField(default=False, verbose_name='是否允许自提')),
                ('postage_setup', models.CharField(choices=[('free', '免邮'), ('distance', '按距离计算')], max_length=128,
                                                   verbose_name='运费设置')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='qfile.File',
                                   verbose_name='图片')),
            ],
            options={
                'verbose_name': '订阅商品图片',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postage_setup', models.CharField(choices=[('free', '免邮'), ('distance', '按距离计算')], max_length=128,
                                                   verbose_name='运费设置')),
                ('postage', models.TextField(blank=True, null=True, verbose_name='运费')),
                ('banners', models.ManyToManyField(related_name='template_banners', to='goods.SubGoodsImage',
                                                   verbose_name='详情页轮播图')),
                ('category',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='goods.GoodsCategory',
                                   verbose_name='商品类别')),
                ('details', models.ManyToManyField(related_name='template_details', to='goods.SubGoodsImage',
                                                   verbose_name='商品详情图')),
            ],
            options={
                'verbose_name': '订阅商品模板',
        ...
        migrations.AddField(
            model_name='subgoodstemplate',
            name='image',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='qfile.File',
                                    verbose_name='封面图'),
        ),
        migrations.AddField(
            model_name='subgoodstemplate',
        ...
        migrations.AddField(
            model_name='subgoods',
            name='banners',
            field=models.ManyToManyField(related_name='subgoods_banners', to='goods.SubGoodsImage',
                                         verbose_name='详情页轮播图'),
        ),
        migrations.AddField(
            model_name='subgoods',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='goods.GoodsCategory',
                                    verbose_name='商品类别'),
        ),
        migrations.AddField(
            model_name='subgoods',
            name='details',
            field=models.ManyToManyField(related_name='subgoods_details', to='goods.SubGoodsImage',
                                         verbose_name='商品详情图'),
        ),
        migrations.AddField(
            model_name='subgoods',
