...
class FeedBackSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FeedBack
        fields = generate_fields(FeedBack,
                                 add=['user_info', 'update_status', 'goods_info', 'order_info', 'operation_log'])
    ...
    def get_operation_log(self, instance):
        if instance.operation_log.all():
            return FeedbackOperationLogSerializer(instance=instance.operation_log.all(), many=True,
