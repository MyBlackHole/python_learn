...
class RefundRecord(models.Model):
    ...
    order = models.ForeignKey('trade.Orders', related_name='refund_records', verbose_name='退款记录',
                              on_delete=models.CASCADE)
    user = models.ForeignKey('wxapp.WxUser', related_name='refund_records', verbose_name='微信用户',
                             on_delete=models.CASCADE)
