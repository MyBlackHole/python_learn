    ...
    columns = [
        {
            ...
            dataIndex: 'title',
            key: 'title',
            render: t => < div style = {{maxWidth: 300}
}
...
=>
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 标题
: <
    /span>
    < Input
    onChange = {e
=>
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > Up主
: <
    /span>
    < Input
    onChange = {e
=>
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 上传时间
: <
    /span>
    < RangePicker
    value = {
