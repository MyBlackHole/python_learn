...
class CloudSave extends Component {
    ...
    render() {
        ...
        title = {'当前云存储容量'} >
            < Meta
        avatar = { < div
        className = {styles.bigSize} > 10 < span > GB < /span></
        div >
    }
        title = "约可存储300个视频文件。"
        description = {
    ...
    <
        ...
        onChange = {(e)
    =>
        this.handleChange(e, 'size')
    }>
        {
            gbList.map(item => < Option
            key = {item}
        ...
        .
            ...
            type = 'primary'
            onClick = {this.handleSubmit} > 马上扩容 < /Button>
                < /div>
        }
        />
        < /Card>
    ...
    =>
        ...
        .
            ...
            type = 'primary'
            onClick = {this.handleSubmit} > 马上续费 < /Button>
                < /div>
        }
        />
        < /Card>
