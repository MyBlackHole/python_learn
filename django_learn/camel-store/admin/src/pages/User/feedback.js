...
:
    ...
    onClick = {()
=>
    this.handleModal(r.update_status, t)
}
    style = {
    {
        cursor:'pointer'
...
,
        ...
        key = "1" >
            < div > 用户名：
                ...
                <
                    ...
                    onClick = {()
                =>
                    this.toGoodpage(record.goods || record.order,
    ...
    :
        '取消',
            okText
    : <
        span > {record.solve ? '标记为未解决' : '标记为已解决'} < /span>,
        onOk()
        {
            record.update_status ? that.handleModal(record.update_status, record.solve) : null
        }
    })
    }
    //跳转商品详情
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 微信用户
    : <
        /span>
        < Input
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 电话号码
    : <
        /span>
        < Input
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 是否解决
    : <
        /span>
        < Select
    ...
    <
        Option
        value = "true" > 已解决 < /Option>
            < Option
        value = "false" > 未解决 < /Option>
            < /Select>
            < /div>
            < div
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 反馈时间
    : <
        /span>
        < RangePicker
        value = {
            tradeform
            .add_time_after ? [moment(tradeform.add_time_after, 'YYYY-MM-DD'), moment(tradeform.add_time_before, 'YYYY-MM-DD')] : null
        }
