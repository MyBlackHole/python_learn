...
:
    ...
    onClick = {()
=>
    this.handleModalUser(r.url, t, r.nickname, 'testers')
}
    style = {
    {
        cursor: 'pointer'
...
<
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 会员等级
    : <
        /span>
        < Select
        style = {
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 加入时间
    : <
        /span>
        < RangePicker
        value = {
        ...
        < /div>
        {
            bonus_switch ? (
                ...
                < span
            className = {styles.searchitem_span} > 分销返佣
        : <
            /span>
            < Select
            style = {
        ...
        }
        {
            rebate_switch ? (
                < div className = {styles.searchitem} >
                < span
            className = {styles.searchitem_span} > 商品推广返利
        : <
            /span>
            < Select
            style = {
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 测试人员
    : <
        /span>
        < Select
        style = {
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 短视频上传
    : <
        /span>
        < Select
        style = {
