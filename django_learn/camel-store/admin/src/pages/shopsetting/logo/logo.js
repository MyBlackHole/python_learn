...
class Logo extends Component {
    ...
    =>
        ...
        handleSource = {()
    =>
        this._openModal('square_logo', square_logo ? [square_logo].length < 1 : [])
    }
        restprops = {
        {
    ...
    =>
        ...
        handleSource = {()
    =>
        this._openModal('rectangle_logo', rectangle_logo ? [rectangle_logo].length < 1 : [])
    }
        restprops = {
        {
            openFileDialogOnClick: false
    ...
    <
        ...
        onClick = {this.validForm} > 保存 < /Button>
            < /div>
            < /Card>
            < Modal
        width = "60%"
