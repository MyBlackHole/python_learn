...
:
    ...
    onChange = {(e)
=>
    this.statusHandle(e, r.id, r.name)
}
>
<
    Option
...
<
    ...
    to = {
    {
        pathname: `/setting/storelist/editstore`, query
    :
        {
            id: r.id
        }
...
<
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 门店名称
: <
    /span>
    < Input
...
=>
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 门店地址
: <
    /span>
    < Input
...
<
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 门店状态
: <
    /span>
    < Select
    style = {
