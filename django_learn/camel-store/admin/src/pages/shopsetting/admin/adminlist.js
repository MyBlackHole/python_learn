...
<
    ...
    onClick = {()
=>
    this.pwdModal(r.reset_password_url, r.username)
}>
<
    a > 重置密码 < /a>
    < /span>
    ...
    to = {
    {
        pathname: `/setting/adminlist/editadmin`, query
    :
        {
            id: r.id
        }
...
<
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 管理员名称
: <
    /span>
    < Input
...
=>
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 管理员类型
: <
    /span>
    < Select
    style = {
    ...
    onChange = {(e)
=>
    this.handleChange('groups', e)
}
>
    {
        adminType.map(item => < Option
        value = {item.id}
        key = {item.id}
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 所属门店
    : <
        /span>
        < Select
        placeholder = "请选择"
        ...
        onChange = {(e)
    =>
        this.handleChange('shop', e)
    }
    >
        {
            shoplist.map(item => < Option
            value = {item.id}
            key = {item.id}
            label = {item.name} > {item.name} < /Option>)}
                < /Select>
