...
class Editadmin extends Component {
    ...
    render() {
        ...
        onChange = {e
    =>
        this.adminHandle('username', e.target.value)
    }
        />
        < /FormItem>
        < FormItem
    ...
    =>
        ...
        onChange = {e
    =>
        this.adminHandle('email', e.target.value)
    }
        />
        < /FormItem>
        < FormItem
