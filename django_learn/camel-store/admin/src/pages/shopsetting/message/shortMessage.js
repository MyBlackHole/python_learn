...
class ShortMessage extends Component {
    ...
    =>
        ...
        type = {'primary'}
        onClick = {this.addAmount} > 充值 < /Button>
            < /Form.Item>
            < Card
        bordered = {false}
        bodyStyle = {
    ...
    <
        ...
        < p > 1、短信发送收费￥0
        .1 / 条 < /p>
        < p > 2、充值逢百送十，如充值￥100，实得￥110（即1100条短信），充值￥270，实得￥290（即2900条短信），以此类推。<
        /p>
        < p > 3、每次充值金额不少于￥10的整数。<
        /p>
        < /Card>
    ...
    =>
        ...
        < /Button>]}>
        < img
        src = {qrcode.base64_qr_cde && 'data:image/png;base64,' + qrcode.base64_qr_cde}
        />
        < Alert
        type = "info"
        showIcon
