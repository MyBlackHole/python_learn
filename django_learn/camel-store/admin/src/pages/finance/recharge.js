...
:
    (t, r) =>
<
    Fragment > {statusText[t]}
    {
        t === 'unpaid' && < a
        onClick = {()
    =>
        this.freshOrder(r.rchg_no)
    }>
        (刷新) < /a>}</
        Fragment >
    }
...
,
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 微信用户昵称
    : <
        /span>
        < Input
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 充值时间
    : <
        /span>
        < RangePicker
        value = {
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 微信支付流水号
    : <
        /span>
        < Input
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 支付状态
    : <
        /span>
        < Select
    ...
    <
        Option
        value = "unpaid" > 待付款 < /Option>
            < Option
        value = "paid" > 已付款 < /Option>
            < /Select>
            < /div>
            < /Fragment>
    }
