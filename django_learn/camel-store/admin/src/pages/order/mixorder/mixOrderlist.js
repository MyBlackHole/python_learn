...
class mixOrderlist extends Component {
    ...
    ,
        ...
        :
            ...
            to = {
            {
                pathname: `/order/mixOrderlist/mixeditorder`, query
            :
                {
                    id:record.id
                }
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 拼团号
    : <
        /span>
        < Input
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 拼团发起人昵称
    : <
        /span>
        < Input
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 拼团商品
    : <
        /span>
        < Input
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 拼团状态
    : <
        /span>
        < Select
    ...
    <
        Option
        value = "build" > 拼团中 < /Option>
            < Option
        value = "done" > 拼团成功 < /Option>
            < Option
        value = "fail" > 拼团失败 < /Option>
            < /Select>
            < /div>
            < div
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 拼团发起时间
    : <
        /span>
        < RangePicker
        value = {
            orderform
            .add_time_after ? [moment(orderform.add_time_after, 'YYYY-MM-DD'), moment(orderform.add_time_before, 'YYYY-MM-DD')] : null
        }
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 拼团用户昵称
    : <
        /span>
        < Input
    ...
    <
        ...
        onChange = {(e)
    =>
        this.personHandle(e, 'robot_goods')
    }
        />
        < /div>
        < div
