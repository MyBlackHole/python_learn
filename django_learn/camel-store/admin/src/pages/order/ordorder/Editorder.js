...
class Editorder extends Component {
    ...
    render() {
        ...
        title = "商品信息" >
            ...
            < Fragment >
            {
        !orderdata.fictitious && < h3 > < b > 快递公司配送 < /b></
        h3 >
    }
    <
        GoodInfoTable
    ...
    :
        ...
        <
            Fragment >
            {
            !orderdata.fictitious && < h3 > < b > 商家自配送 < /b></
            h3 >
        }
        <
            GoodInfoTable
        ...
        <
            Fragment >
            {
            !orderdata.fictitious && < h3 > < b > 用户自提 < /b></
            h3 >
        }
        <
            GoodInfoTable
