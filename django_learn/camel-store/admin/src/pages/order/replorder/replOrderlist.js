...
class replOrderlist extends Component {
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 订单编号
    : <
        /span>
        < Input
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 商品名称
    : <
        /span>
        < Input
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 规格名称
    : <
        /span>
        < Input
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 订单状态
    : <
        /span>
        < Select
    ...
    <
        Option
        value = "paying" > 待付款 < /Option>
            < Option
        value = "has paid" > 待发货 < /Option>
            < Option
        value = "receiving" > 待收货 < /Option>
            < Option
        value = "done" > 交易成功 < /Option>
            < Option
        value = "close" > 交易关闭 < /Option>
            < /Select>
            < /div>
            < div
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 下单时间
    : <
        /span>
        < RangePicker
        value = {
