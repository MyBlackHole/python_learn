...
class ordertableList extends Component {
    ...
    render() {
                ...
                render: t => (
                    < Fragment >
                    {
                        t.map(item => {
                            return
                        <
                            div > {item.goods_name + '-' + item.gtype_name + '*' + item.num} < /div>;
                        })
                    }
                    < /Fragment>
    ),
        ...
        :
            'order_amount',
                render
        :
            (t, r) => (t * 1 + r.postage_total * 1).toFixed(2)
        }
    ,
        {
            title: '下单时间',
        ...
        :
            'add_time',
                render
        :
            t => (t ? moment(t).format('YYYY-MM-DD HH:mm:ss') : null),
        }
    ,
        {
            title: '微信用户',
    ...
    ,
        ...
        :
            (t, r) =>
        <
            span > {goodtype === 'sub' ? substatus_group[t] : status_group[t]
        }
            {
                t === 'paying' && < a
                onClick = {()
            =>
                this.freshOrder(r.order_sn)
            }>
                (刷新) < /a> }</s
                pan >,
            }
        ...
        ,
            ...
            const subcolumn = [
                        ...
                        {moment(t).format('YYYY-MM-DD')}{' '}
                {
                    ...
                    arrowPointAtCenter >
                < img style = {{width: 20, marginLeft: '5px'}
        }
            src = {tixing}
            />
            < /Tooltip>
        ...
        <
            ...
            scroll = {
            {
                x: scroll || textColumn[goodtype].length * 150
            }
        }
        ...
        =>
            {
                ...
                onChange = {(e)
            =>
                this.setState({expressCompany: e})
            }
                style = {
                {
                    width: 120, marginRight
                :
                    10
                }
            }>
            <
                Select.Option
                value = 'SF' > 顺丰 < /Select.Option>
                    < Select.Option
                value = 'ZT' > 中通 < /Select.Option>
                    < /Select>
                    < Button
        ...
        >
            ...
            <
                Fragment >
                {
                !rowdata.fictitious && < h3 > < b > 快递公司配送 < /b></
                h3 >
            }
            <
                GoodInfoTable
            ...
            =>
                ...
                value = {
                {
                    rowdataid, orderdata_item
                :
                    express, isdetail
                :
                    false, delivery_method
                :
                    'express'
                }
            }
            ...
            <
                Fragment >
                {
                !rowdata.fictitious && < h3 > < b > 商家自配送 < /b></
                h3 >
            }
            <
                GoodInfoTable
            ...
            <
                Fragment >
                {
                !rowdata.fictitious && < h3 > < b > 用户自提 < /b></
                h3 >
            }
            <
                GoodInfoTable
        ...
        <
            ...
            :
                {
                    id: detailform.user_info && detailform.user_info.id
                }
            }
        }>
        <
        ...
        <
            ...
            < FormItem
            label = "会员钱包扣款额" >
                {Number(detailform.wallet_pay
        ) ===
            0 ? '--' : `￥ ${detailform.wallet_pay}`
        }
        <
            /FormItem>
            < FormItem
            label = "微信支付金额" >
                {Number(detailform.real_amount
        ) ===
            0 ? '--' : `￥ ${detailform.real_amount}`
        }
        <
            /FormItem>
            < FormItem
