...
class orderInfo extends Component {
    ...
    render() {
        ...
        const {
            edit_order, singerform, onLoading,
            accountLogs, acc_columns, acc_page, accountCount,
            creditLogs, cred_columns, cred_page, creditCount
        } = this.state
        ...
        :
            {
                id: formdata.user_info && formdata.user_info.id
            }
        }
    }>
    <
    ...
    <
        ...
        label = "配送门店" >
            ...
            {
                formdata
                .entrust_shop_info && formdata.entrust_shop_info.name || formdata.shop_info && formdata.shop_info.name
            }
            < /span>
            < /FormItem>
        {
        ...
        <
            FormItem
            label = "订单状态" >
                < span > {orderstatus_group[formdata.status]}
            {
                formdata.status === 'paying' && < a
                onClick = {()
            =>
                this.freshOrder(formdata.order_sn)
            }>
                (刷新) < /a> }</s
                pan >
                < /FormItem>
            ...
            }
            {
                ...
                label = "会员钱包支付" >
                    < span > ￥
                {
                    Number(formdata.wallet_pay).toFixed(2)
                }
            <
                /span>
                < /FormItem>
        ...
        <
            ...
            <
                ...
                onChange = {e
            =>
                this.singerHandle(e, 'mobile_phone')
            }
                />
            ) :
                (
            ...
            <
                ...
                onChange = {e
            =>
                this.singerHandle(e, 'address_info')
            }
                />
            ) :
                (
