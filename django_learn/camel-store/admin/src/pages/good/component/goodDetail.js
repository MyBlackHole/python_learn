...
class goodDetail extends Component {
    ...
    */
    ...
    render() {
        ...
        const goodgroups = listdata.map(item => < Option
        key = {item.id}
    ...
    <
        Spin
        spinning = {Boolean(GoodsLoading || upLoading
    )
    }
        tip = "正在操作中" >
            < Tabs
    ...
    <
        /Select>
        < Link
        to = '/good/template/goodlistTemplate/editgoodTemplate?id'
        style = {
        {
            marginLeft: 10
        }
    ...
    }
        {
            ...
            onChange = {e
        =>
            this.chnangegooddata(e, 'category')
        }
            />
            < Link
            to = '/good/categorylist/editpage?id'
            style = {
            {
                marginLeft: 10
            }
        ...
        =>
            ...
            />{' '}
            {
                is_build ?
            <
                a > 该商品仍然有人在拼团，可以关闭拼团功能，不可更改拼团数据设置 < /a> : null}
            < /FormItem>
            }
        <
            FormItem
        ...
        =>
            ...
            <
                Option
                value = "is_sell" > 在售 < /Option>
                    < Option
                value = "preview" > 预览 < /Option>
                    < Option
                value = "not_sell" > 下架 < /Option>
                    < /Select>
                    < /FormItem>
            :
                null
            ...
            <
                Radio
                value = "long_term" > 长期 < /Radio>
                    < Radio
                value = "time_frame" > 具体日期 < /Radio>
                    < RangePicker
                size = "small"
                disabled = {
                !createTem || !(gooddata.sub_goods.duration === "time_frame")
            }
                value = {
                    gooddata
                    .sub_goods.duration_start ? [moment(gooddata.sub_goods.duration_start), moment(gooddata.sub_goods.duration_end)] : null
                }
        ...
        =>
            ...
            onChange = {e
        =>
            this.chnangegooddata(e, textSwitch[model_type].key, 'gtypes')
        }
            />
            < /TabPane>
        ...
        =>
            {
                this.chnangegooddata(e.target.value, 'sub_goods', 'delivery_setup')
            }
        }
        ...
        <
            Radio
            value = "date" > 配送日期 < /Radio>
                < Radio
            value = "interval" > 固定间隔 < /Radio>
                < /RadioGroup>
                < /FormItem>
                < FormItem
            label = "配送日期设置" >
        ...
        =>
            {
                this.chnangegooddata(e.target.value, 'sub_goods', 'date_setup')
            }
        }
            value = {gooddata.sub_goods.date_setup}
            disabled = {
            !createTem || !(gooddata.sub_goods.delivery_setup === 'date')
        }>
        <
            Radio
            value = "specific" > 具体日期 < /Radio>
                < Radio
            value = "weekly" > 每周设置 < /Radio>
                < /RadioGroup>
            {
            ...
            <
                ...
                limit = {
                    gooddata
                    .sub_goods.duration === "time_frame" ? [gooddata.sub_goods.duration_start, gooddata.sub_goods.duration_end] : null
                }
                onChange = {(e)
            =>
                this.chnangegooddata(e, 'sub_goods', 'delivery_data', 'specific')
            }
                />
            :
                null
        ...
        <
            ...
            style = {
                    gooddata
                    .sub_goods.delivery_setup === 'date' && gooddata.sub_goods.date_setup === 'weekly' ? {} : {display: 'none'}
                } >
                < CheckboxGroup
            value = {delivery_data.weekly}
            onChange = {(e)
        =>
            this.chnangegooddata(e, 'sub_goods', 'delivery_data', 'weekly')
        }>
        <
            Checkbox
            value = "1" > 周一 < /Checkbox>
            ...
            label = "固定间隔/天" >
                < InputNumber
            disabled = {
            !createTem || !(gooddata.sub_goods.delivery_setup === 'interval')
        }
            style = {
            {
                width: 250
        ...
        =>
            {
                this.chnangegooddata(str, 'sub_goods', 'send_start')
            }
        }
            />
            < span
        ...
        =>
            ...
            <
                    ...
                    < /FormItem>
                {
                    ...
                    onChange = {e
                =>
                    this.chnangegooddata(e, textSwitch[model_type].key, 'estimate_time')
                }
                    />
                    < /FormItem>
                ) :
            ...
            <
                FormItem
                label = "运费设置"
                style = {model_type === 'replace' ? {display: 'none'} : {}
            }>
            <
                RadioGroup
                onChange = {e
            ...
            <
                ...
                < /RadioGroup>
                {
                    ...
                    onChange = {e
                =>
                    this.chnangegooddata(e, 'postage')
                }
                    />
                ) :
                    null
