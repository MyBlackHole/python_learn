...
:
    ...
    onClick = {()
=>
    this.delModal(record.content, record.index)
}>
<
    a > 删除 < /a>
    < /span>
...
switch = stair => {
    ...
    <
        ...
        onChange = {e
    =>
        this.chnageModaldata(e, 'ladder_list', label)
    }
        />
        < /FormItem_S>
    )
    ...
    <
        /FormItem_S>
        {
            ...
            onChange = {e
        =>
            this.chnageModaldata(e, 'buy_limit')
        }
            />
            < /FormItem_S>
        )
        ...
        }
        {
            ...
            onChange = {e
        =>
            this.chnageModaldata(e, 'cycle_num')
        }
            />
            < /FormItem_S>
        )
