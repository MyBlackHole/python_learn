...
class bookTime extends Component {
    ...
    =>
        ...
        disabledMinutes = {(e)
    =>
        this.disabledMinutes(e, r.add[0])
    }
        onChange = {(time, timeString)
    =>
        ...
        :
            ...
            onChange = {(e)
        =>
            this.ontimeChange(e, 'sendtype', null, r.key)
        }>
        <
            Option
            value = "today" > 下单当日 < /Option>
                < Option
            value = "tomorrow" > 下单次日 < /Option>
                < /Select>
                < Time_Picker
    ...
    ,
        ...
        :
            ...
            onClick = {()
        =>
            this.ontimeChange('', null, null, r.key)
        }
            style = {
            {
                color:'red'
    ...
    ,
        ...
        onClick = {this.addlist} > 添加 < /Button>
            < /Fragment>
    )
    }
}
