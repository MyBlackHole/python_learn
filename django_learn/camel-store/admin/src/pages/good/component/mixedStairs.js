...
class mixedStairs extends Component {
    ...
    =>
        ...
        value = {mode} >
            < Radio
        value = "people" > 成团人数 < /Radio>
            < Radio
        value = "goods" > 成团商品件数 < /Radio>
            < /RadioGroup>
            < List
        dataSource = {_stairs}
    ...
    =>
        ...
        onClick = {()
    =>
        this.disthandle(item, '', item.index)
    }
        style = {edit ? {color: 'red'} : {display: 'none'}} > 删除 < /a>]}>
            < span
        style = {
        {
            marginRight: 10
    ...
    <
        ...
        <
            ...
            onChange = {(e)
        =>
            this.disthandle(e, 'num', item.index)
        }
            />
        :
            item.num
    ...
    <
        ...
        disabled = {disabled} > {edit ? '添加' : '编辑'} < /Button>
        {
            edit ?
        <
            Button
            ...
            type = "primary"
            onClick = {this.savedist} > 保存 < /Button>
        :
            null
        }
    <
