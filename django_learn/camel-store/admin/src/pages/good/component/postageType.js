...
class postageType extends Component {
    ...
    <
        ...
        onChange = {(e)
    =>
        this.disthandle(e, 'start', item.key)
    }
        />
        < span
        style = {
        ...
        onChange = {(e)
    =>
        this.disthandle(e, 'end', item.key)
    }
        />
        < span
        style = {
        {
            marginLeft: 30, marginRight
        :
            10
        }
    }>
        ...
        onChange = {(e)
    =>
        this.disthandle(e, 'cost', item.key)
    }
        />
        < /List.Item>
    )
        ...
        onClick = {this.adddist} > 添加 < /Button>)}
        />
        < /Fragment>
    )
    }
