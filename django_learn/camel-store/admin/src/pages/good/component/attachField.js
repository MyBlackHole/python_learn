...
class attachField extends Component {
    ...
    columns = [
        ...
        < FormItem label = {r.label} required = {r.is_required} >
            ...
            < Input maxLength = {r.length === null ? Infinity : r.length} style = {{width: 200}
}
...
,
    ...
    <
        ...
        onChange = {(e)
    =>
        this.onChangeModal(e.target.value, 'label')
    }
        ...
        onChange = {(e)
    =>
        this.onChangeModal(e, 'attach_type')
    }>
    <
        Option
        key = "string" > 文字 < /Option>
            < Option
        key = "number" > 数字 < /Option>
            < Option
        key = "date" > 日期 < /Option>
            < Option
        key = "radio" > 单选 < /Option>
            < Option
        key = "checkbox" > 多选 < /Option>
            < /Select>
            < /FormItemS>
            < FormItemS
        label = "是否必填" >
        ...
        onChange = {(e)
    =>
        this.onChangeModal(e, 'is_required')
    }
        />
        < /FormItemS>
        < FormItemS
        ...
        onChange = {(e)
    =>
        this.onChangeModal(e.target.value, 'help_text')
    }
        ...
        <
            ...
            onChange = {(e)
        =>
            this.onChangeModal(e, 'min_value')
        }
            />
            < /FormItemS>
            < FormItemS
            ...
            onChange = {(e)
        =>
            this.onChangeModal(e, 'max_value')
        }
            />
            < /FormItemS>
            < /Fragment>
