...
class Editpage extends Component {
    ...
    render() {
        ...
        title = {id ? '编辑商品类别' : '新增商品类别'} >
            < Spin
        spinning = {Boolean(onUpload || upload
    )
    }
        tip = '正在操作中' >
            < Form
    ...
    <
        ...
        onChange = {(e)
    =>
        this.handlecategory(e.target.value, 'name')
    }
        />
        < /FormItem>
        < FormItem
    ...
    <
        ...
        onChange = {(e)
    =>
        this.handlecategory(e, 'is_active')
    }
        />
        < /FormItem>
        {
