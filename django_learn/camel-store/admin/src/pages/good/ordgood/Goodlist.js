...
class Goodlist extends Component {
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 商品名
    : <
        /span>
        < Input
        value = {goodform.name}
    ...
    =>
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 商品类别
    : <
        /span>
        < CategorySelect
        type = "search"
        ...
        onChange = {(e)
    =>
        this.handlegoodform('category', {target: {value: e}})
    }
        />
        < /div>
        < div
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 商品状态
    : <
        /span>
        < Select
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 添加时间
    : <
        /span>
        < RangePicker
        value = {
            goodform
            .date_time_after ? [moment(goodform.date_time_after, 'YYYY-MM-DD'), moment(goodform.date_time_before, 'YYYY-MM-DD')] : null
        }
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 是否热门商品
    : <
        /span>
        < Select
        ...
        onChange = {(e)
    =>
        this.handlegoodform('recommendation', {target: {value: e}})
    }
        style = {
        {
            width: 200
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 是否虚拟商品
    : <
        /span>
        < Select
        ...
        onChange = {(e)
    =>
        this.handlegoodform('fictitious', {target: {value: e}})
    }
        style = {
        {
            width: 200
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > 是否拼团商品
    : <
        /span>
        < Select
        ...
        onChange = {(e)
    =>
        this.handlegoodform('groupbuy', {target: {value: e}})
    }
        style = {
        {
            width: 200
    ...
    =>
        ...
        to = {
        {
            pathname:`/good/ordgood/goodlist/editgood`, query
        :
            {
                id:null
            }
