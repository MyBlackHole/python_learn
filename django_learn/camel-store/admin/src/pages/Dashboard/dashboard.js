...
class dashboard extends Component {
    ...
    <
        ...
        onClick = {()
    =>
        this.toItempage('user/feedback', 'feedback', {solve: 'false'})
    }
    >
    <
        Meta
    ...
    <
        ...
        onClick = {()
    =>
        this.toItempage('good/ordgood/goodlist', 'good', {status: 'is_sell'})
    }
    >
    <
        Meta
    ...
    <
        ...
        /span>
        < span
        style = {detailStyle} > {order_count} < /span>
            < /div>
            < /Carditem>
            < Carditem
        className = {styles.cardtabBig}
    ...
    <
        ...
        /span>
        < span
        style = {detailStyle} > {countform.turnovers && countform.turnovers.week_ago} < /span>
            < /div>
            < div
        style = {divStyle} >
            < span
        ...
        bodyStyle = {
        {
            paddingTop: 0, boxShadow
        :
            '0px 0px 1px rgba(238,238,238,1)'
        }
    }
        title = {
            < div
