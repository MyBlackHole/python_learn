...
class Analysis extends Component {
    ...
    <
        ...
        defaultMessage = "Weekly Changes" / >
            < span
        className = {styles.trendText} > 12 % < /span>
            < /Trend>
            < Trend
        flag = "down" >
            < FormattedMessage
        ...
        defaultMessage = "Daily Changes" / >
            < span
        className = {styles.trendText} > 11 % < /span>
            < /Trend>
            < /ChartCard>
            < /Col>
            < Col
    ...
    <
        ...
        title = {item.title} >
            ...
            < /span>
            < span
        className = {styles.rankingItemValue} >
            {numeral(item.total
    ).
        format('0,0')
    }
    ...
    <
        ...
        titleMap = {
        {
            y1: formatMessage({id: 'app.analysis.traffic'}),
                y2
        :
            formatMessage({id: 'app.analysis.payments'}),
        }
    }
        />
        < /div>
