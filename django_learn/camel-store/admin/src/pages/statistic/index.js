...
class statistic extends Component {
    ...
    initChart = (idname, res, keylist) => {
        ...
        const textlist = {
            ...
            order: {
                title: '订单数', label: ['普通订单', '订阅商品订单', '积分商品订单', '线下支付订单', '总订单'],
                showtype: ['bar', 'bar', 'bar', 'bar', 'line'],
                stack: ['order', 'order', 'order', 'order', undefined],
                xAxis: true
            },
            turnovers: {
                title: '销售额', label: ['普通商品销售额', '订阅商品销售额', '线下销售额', '总销售额'],
    ...
    <
        ...
        onChange = {(e, str)
    =>
        this.timeChange(str, 'feedbackdate')
    }
        />
        < /Col>
        < Col
    ...
    <
        ...
        onChange = {(e, str)
    =>
        this.timeChange(str, 'rechargedate')
    }
        />
        < /Col>
        < /Row>
    ...
    <
        ...
        onChange = {(e, str)
    =>
        this.timeChange(str, 'withdrawdate')
    }
        />
        < /Col>
        < /Row>
