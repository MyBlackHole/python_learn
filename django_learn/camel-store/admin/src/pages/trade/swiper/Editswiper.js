...
class Editswiper extends Component {
    ...
    render() {
        ...
        return (
            < PageHeaderWrapper >
            < Spin
        spinning = {Boolean(Upload || swiperLoading
    )
    }
        tip = '操作中' >
            < Card
    ...
    <
        ...
        onChange = {(e)
    =>
        this.handleswiper(e, 'goods_name')
    }
        />
        < /FormItem>
    ...
    =>
        ...
        handleSource = {()
    =>
        this.openModal(swiperdata.image ? [swiperdata.image].length < 1 : [].length < 1)
    }
        restprops = {
        {
    ...
    <
        ...
        onClick = {this.handleSubmit} > 保存 < /CButton>
            < /Col>
            < /Row>
            < /Form>
            < /Card>
