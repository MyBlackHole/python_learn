...
<
    Fragment >
    {r.referral_avatar_url && < img src = {r.referral_avatar_url} width = "30" style = {
    {
        marginRight: 10
    }
}
...
,
    ...
    <
        ...
        className = {styles.searchitem} >
            < span
        className = {styles.searchitem_span} > {type === 'accountlog' ? '消费用户:' : '返利用户:'
    }<
        /span>
        < Input
    ...
    =>
        ...
        < /div>
        {
            ...
            className = {styles.searchitem} >
                < span
            className = {styles.searchitem_span} > 奖励用户
        : <
            /span>
            < Input
