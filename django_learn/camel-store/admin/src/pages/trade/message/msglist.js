...
<
    ...
    to = {
    {
        pathname: `/trade/shopmessage/editmessage`, query
    :
        {
            id:r.id
        }
...
<
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 消息标题
: <
    /span>
    < Input
    placeholder = "请输入消息标题"
    ...
    onChange = {(e)
=>
    this.handleshop('title', e.target.value)
}
    />
    < /div>
    < div
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 创建时间
: <
    /span>
    < RangePicker
    value = {
        shopform
        .create_time_after ? [moment(shopform.create_time_after, 'YYYY-MM-DD'), moment(shopform.create_time_before, 'YYYY-MM-DD')] : null
    }
...
<
    ...
    className = {styles.searchitem} >
        < span
    className = {styles.searchitem_span} > 是否启用
: <
    /span>
    < Select
    style = {
