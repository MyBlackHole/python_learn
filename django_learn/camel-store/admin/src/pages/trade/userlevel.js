...
<
    ...
    onChange = {e
=>
    this.handlelevel('title', e.target.value)
}
    />
    < /FormItem>
    < FormItem
...
=>
    ...
    onChange = {(e, list)
=>
    this.handleUpload(e, 'icon', list)
}
    handleSource = {()
=>
    this._openModal(fileList.length < 1)
}
    restprops = {
    {
