...
class tableDrag extends React.Component {
    ...
    <
        ...
        className = "ant-spin-container" >
            < div
        className = "ant-table ant-table-small ant-table-scroll-position-left" >
            < div
    ...
    <
        table
        style = {isNaN(widthtable) ? {} : {width: widthtable + 'px'}
    }
        id = "tableDrag" >
            < thead
        className = "ant-table-thead" >
            < tr >
            {
                columns.map(item => {
                    ...
                    style = {
                        item
                        .width ? {width: `${item.width}px`, userSelect: 'none'} : {userSelect: 'none'}
                    } > < div > {item.title} < /div></
                    th >
                )
                })
    ...
    >
        {
            columns.map(item_in => {
                return (
                    < td
                style = {item_in.width ? {width: `${item_in.width}px`, userSelect: 'none'} : {userSelect: 'none'}} >
    ...
    <
        ...
        < /div>
        {
            ...
            className = "ant-table-placeholder" > < Empty / > < /div>}
                < /div>
                < /div>
                < /div>
                < /div>
