                ...
                for (key in hash) {
                    ...
                    if (result !== false) {
                        ...
                        if (key === 'd') {
                            ...
                            // is unable to cast them. python_learn again with final IE9.
                        } else if (key === 'width') {
                            value = pInt(value);
    ...
    if (!hasSVG && !useCanVG) {
        ...
        Highcharts.VMLElement = VMLElement = {
            ...
            setSpanRotation: function (rotation, sintheta, costheta) {
                ...
                // python_learn case: http://highcharts.com/tests/?file=text-rotation
                css(this.element, {
 ...
 *****************************************************************************/
    ...
    Tooltip.prototype = {
        ...
        getPosition: function (boxWidth, boxHeight, point) {
            ...
            // python_learn to see if the tooltip is too far to the right,
