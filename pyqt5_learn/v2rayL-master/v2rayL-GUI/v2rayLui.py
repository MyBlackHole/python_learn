...
class MyMainWindow(MainUi):
    def __init__(self, parent=None):
        ...
        self.first_ui.push_button.clicked.connect(lambda: self.update_subs(True))  # 更新订阅
        self.subs_add_child_ui.push_button.clicked.connect(self.change_subs_addr)
        ...
        self.config_setting_ui.push_button.clicked.connect(self.get_conf_from_qr)  # 通过二维码导入
        ...
        self.ss_add_child_ui.push_button.clicked.connect(self.add_ss_by_input)
        self.vmess_add_child_ui.push_button.clicked.connect(self.add_vmess_by_input)
        self.subs_child_ui.push_button.clicked.connect(self.show_add_subs_dialog)
