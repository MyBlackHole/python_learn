...
# （推荐）
print(arrow.get("2017-10-28 05:30:30", "YYYY-MM-DD HH:mm:ss", tzinfo="local"))
...
# 本地化个性时间短语： 刚才，1分钟前，1天前，等　　（zh_tw  更多语言的支持，去查看arrow/locales.py）
print(local.replace(minutes=-1).humanize(locale="zh"))
